...
import { mockBackend, isMockEnabled } from './mockBackend';
...
export const propertiesApi = {
  ...
  get: async (id: string): Promise<ApiResponse<Property>> => {
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      return mockBackend.getProperty(id);
    }
...
export const reservationsApi = {
  ...
  create: async (data: {
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      console.log('🎭 MOCK: Criando reserva via mockBackend');
  ...
  update: async (id: string, data: {
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      console.log('🎭 MOCK: Atualizando reserva via mockBackend');
      return mockBackend.updateReservation(id, data);
    }
  ...
  cancel: async (id: string, reason?: string): Promise<ApiResponse<Reservation>> => {
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      console.log('🎭 MOCK: Cancelando reserva via mockBackend');
      return mockBackend.cancelReservation(id, reason);
    }
  ...
  delete: async (id: string): Promise<ApiResponse<null>> => {
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      console.log('🎭 MOCK: Deletando reserva via mockBackend');
      return mockBackend.deleteReservation(id);
    }
...
export const guestsApi = {
  ...
  create: async (data: {
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      console.log('🎭 MOCK: Criando hóspede via mockBackend');
      return mockBackend.createGuest(data);
    }
...
export const calendarApi = {
  ...
  getData: async (params: {
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      const propsRes = await mockBackend.getProperties();
      const reservRes = await mockBackend.getReservations();
      const blocksRes = await mockBackend.getBlocks();
      
      return {
        success: true,
        data: {
          properties: propsRes.data || [],
          reservations: reservRes.data || [],
  ...
  createBlock: async (data: {
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      console.log('🎭 MOCK: Criando bloqueio via mockBackend');
      return mockBackend.createBlock(data);
    }
  ...
  updateBlock: async (id: string, data: {
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      console.log('🎭 MOCK: Atualizando bloqueio via mockBackend');
      return mockBackend.updateBlock(id, data);
    }
  ...
  deleteBlock: async (id: string): Promise<ApiResponse<null>> => {
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      console.log('🎭 MOCK: Deletando bloqueio via mockBackend');
      return mockBackend.deleteBlock(id);
    }
...
export const locationsApi = {
  ...
  get: async (id: string): Promise<ApiResponse<{
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      return mockBackend.getLocation(id);
    }
  ...
  create: async (data: {
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      return mockBackend.createLocation(data);
    }
  ...
  update: async (id: string, data: Partial<Location>): Promise<ApiResponse<Location>> => {
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      return mockBackend.updateLocation(id, data);
    }
  ...
  delete: async (id: string): Promise<ApiResponse<null>> => {
    ...
    return apiRequest<null>(`/locations/${id}`, {
      method: 'DELETE',
    });
  },
  ...
  getAccommodations: async (id: string): Promise<ApiResponse<{
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      return mockBackend.getLocationAccommodations(id);
    }
...
export const devApi = {
  ...
  seedDatabaseNew: async (): Promise<ApiResponse<{
    ...
    // 🎭 MOCK MODE
    if (isMockEnabled()) {
      return mockBackend.seedDataNew();
    }
