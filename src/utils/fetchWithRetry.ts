  ...
  if (errorMessage.includes('cors') || errorMessage.includes('cross-origin')) {
    return {
      ...
      suggestions: [
        ...
        'Execute: supabase functions deploy make-server-67caf26a'
      ]
    };
  }
  ...
  if (
    ...
    return {
      ...
      suggestions: [
        ...
        'Teste o health check: curl https://uknccixtubkdkofyieie.supabase.co/functions/v1/make-server-67caf26a/health',
