...
import { Plus, Building2, Home, MapPin, Edit, Eye, Trash2, Image as ImageIcon, Grid3x3, List, CheckCircle2, Wrench, DollarSign } from 'lucide-react';
    ...
    try {
      ...
      if (propertiesResponse.success && propertiesResponse.data) {
        const accommodations = propertiesResponse.data
          ...
          .map((prop: any) => ({
            id: prop.id,
            internalName: prop.internalName || prop.name,
            publicName: prop.publicName || prop.name,
