...
export function CreateOrganizationModal({ open, onClose, onSuccess }: CreateOrganizationModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('📍 URL:', `https://${projectId}.supabase.co/functions/v1/make-server-67caf26a/organizations`);
    ...
    try {
      ...
      toast.error('Erro ao criar no servidor', {
        ...
        action: {
          label: 'Criar Offline',
          onClick: createOfflineOrganization
        },
        duration: 10000
      });
      
      const diagnosis = diagnoseFetchError(err as Error);
      setError(diagnosis.message + '\n\n💾 Você pode criar localmente clicando em "Criar Offline"');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="space-y-4 py-4">
            ...
            {testingConnection && (
              <Alert>
                ...
                <AlertDescription>Verificando conexão com backend...</AlertDescription>
              </Alert>
            )}
            ...
            {!testingConnection && backendOffline && (
              <Alert className="bg-yellow-50 border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-800">
                ...
                <AlertDescription className="text-yellow-800 dark:text-yellow-200">
                  ...
                  <br />
                  Backend não está disponível. Organizações serão salvas localmente e sincronizadas quando o backend voltar.
                </AlertDescription>
              </Alert>
            )}
            ...
            {!testingConnection && !backendOffline && (
              <Alert className="bg-green-50 border-green-200 dark:bg-green-900/20 dark:border-green-800">
                ...
                <AlertDescription className="text-green-800 dark:text-green-200">
                  ...
                  <br />
                  Organização será criada diretamente no servidor.
                </AlertDescription>
              </Alert>
            )}
