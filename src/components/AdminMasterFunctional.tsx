  ...
  const loadUsers = async (organizationId?: string) => {
    ...
    try {
      const url = organizationId 
        ? `https://${projectId}.supabase.co/functions/v1/make-server-67caf26a/users?organizationId=${organizationId}`
        : `https://${projectId}.supabase.co/functions/v1/make-server-67caf26a/users`;
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className={`p-4 rounded-lg ${
                    mockMode ? 'bg-purple-50 border border-purple-200' : 'bg-green-50 border border-green-200'
                  }`}>
                    <div className="flex items-start gap-3">
                      <Shield className={`h-5 w-5 mt-0.5 ${mockMode ? 'text-purple-600' : 'text-green-600'}`} />
                      <div>
                        <div className={`font-medium ${mockMode ? 'text-purple-900' : 'text-green-900'}`}>
                          Status Atual: {mockMode ? 'Mock Mode' : 'Real Mode'}
                        </div>
                        <div className={`text-sm mt-1 ${mockMode ? 'text-purple-700' : 'text-green-700'}`}>
                          {mockMode ? (
                            <>
                              <p>✅ Ideal para desenvolvimento e testes</p>
                              <p>✅ Não requer configuração do backend</p>
                              <p>⚠️ Dados NÃO persistem entre dispositivos</p>
                            </>
                          ) : (
                            <>
                              <p>✅ Dados persistem globalmente</p>
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm text-blue-900">
                        ...
                        <p>Ao alternar o modo, a página será recarregada automaticamente.</p>
                        <p>Os dados de cada modo são independentes e não são compartilhados.</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
