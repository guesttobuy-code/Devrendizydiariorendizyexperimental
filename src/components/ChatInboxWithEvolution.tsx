...
export function ChatInboxWithEvolution() {
  ...
  const [activeTab, setActiveTab] = useState<'whatsapp' | 'inbox'>('whatsapp');

  const handleContactSelect = (contact: LocalContact) => {
    setSelectedContact(contact);
    console.log('📱 Contato selecionado:', contact);
    // TODO: Abrir conversa com este contato
  };
    ...
    <div className="flex h-full">
      ...
      <div className="w-80 border-r bg-white flex flex-col">
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)} className="flex-1 flex flex-col">
          ...
          <TabsContent value="whatsapp" className="flex-1 mt-0">
