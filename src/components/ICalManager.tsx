...
export function ICalManager({ listingId, listingName }: { listingId: string; listingName: string }) {
  ...
  const loadFeeds = async () => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-67caf26a/listings/${listingId}/ical-feeds`,
        {
          headers: {
  ...
  const syncFeed = async (feedId: string) => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-67caf26a/ical-feeds/${feedId}/sync`,
        {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${publicAnonKey}`
  ...
  const deleteFeed = async (feedId: string) => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-67caf26a/ical-feeds/${feedId}`,
        {
          method: 'DELETE',
          headers: {
            'Authorization': `Bearer ${publicAnonKey}`
  ...
  const loadEvents = async (feedId: string) => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-67caf26a/ical-feeds/${feedId}/events`,
        {
          headers: {
            'Authorization': `Bearer ${publicAnonKey}`
          }
  ...
  const generateExportUrl = () => {
    const url = `https://${projectId}.supabase.co/functions/v1/make-server-67caf26a/listings/${listingId}/ical/export`;
    setExportUrl(url);
  };
