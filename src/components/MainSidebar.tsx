      ...
      items: [
        ...
        },
        {
          ...
          submenu: [
            ...
            { id: 'usuarios-clientes', label: 'Clientes', icon: Users },
            { id: 'usuarios-proprietarios', label: 'Proprietários', icon: Building2 },
            { id: 'usuarios-exportacao-leads', label: 'Exportação de Leads', icon: Download },
            { id: 'usuarios-compras-email', label: 'Compras (por E-mail)', icon: Mail },
            { id: 'usuarios-compras-nome', label: 'Compras (por Nome)', icon: UserCircle },
            { id: 'usuarios-lista-canal', label: 'Lista de Canal', icon: TrendingUp },
            { id: 'usuarios-lista-telefones', label: 'Lista de Telefones', icon: Phone },
            { id: 'usuarios-lista-documentos', label: 'Lista de Documentos', icon: FileText }
          ]
        },
        {
          id: 'notificacoes',
    ...
    <TooltipProvider>
      ...
      {!collapsed && (
        <div className={cn(
          ...
          <div className="flex items-center gap-3">
            <div className={cn(
              "h-10 w-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center ring-2",
